...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Summary Cards */}
      <DashboardSummary boats={boats} trips={trips} expenses={expenses} />
      
      {/* Boats Table Section */}
      <DataTable title="Boats" onAdd={() => console.log("Add boat")}>
        <BoatsTable boats={boats} />
      </DataTable>

      {/* Trips Table Section */}
      <DataTable title="Trips" onAdd={() => console.log("Add trip")}>
        <TripsTable trips={trips} />
      </DataTable>

      {/* Expenses Table Section */}
      <DataTable title="Expenses" onAdd={() => console.log("Add expense")}>
